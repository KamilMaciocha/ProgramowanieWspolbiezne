...
namespace DataTest {
    public class Tests {
        ...
        public void BallConstructorsTest() {
            ...
            Assert.IsTrue(ball.x() == 0 && ball.y() == 0 && ball.xDirection() == 0 && ball.yDirection() == 0);
            ball = new Ball(5, 7, 1, -1);
            Assert.IsTrue(ball.x() == 5 && ball.y() == 7 && ball.xDirection() == 1 && ball.yDirection() == -1);
        }
